class Main
  ...
  def create_route_menu
    first_station_name = ask_first_station_name
    last_station_name = ask_last_station_name
  ...
  def create_train_menu
    ...
    exception_msg = exception.message.to_s
    @interface.invalid_train_number_msg(exception_msg)
    retry
  ensure
  ...
  def set_train_manufacturer_menu
    train_number = existing_train_number
    train = train_by_number(train_number)
    manufacturer_name = ask_manufacturer_name
